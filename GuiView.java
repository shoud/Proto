...
/** Panel quatres images suivantes */
		...
		image01.setPreferredSize(new Dimension(150,200));
		image02.setPreferredSize(new Dimension(150,200));
		image03.setPreferredSize(new Dimension(150,200));
		image04.setPreferredSize(new Dimension(150,200));
